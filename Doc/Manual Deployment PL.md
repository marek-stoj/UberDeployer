...
Domyœlna œcie¿ka jest ustawiana per œrodowisko (EvironmentInfo.xml - parametr ManualDeploymentPackageDirPath, wiêcej info w [Configuration Guide](Configuration Guide PL.md)).
