...
{
  partial class OpenTargetUrlsForm
  {
    /// <summary>
    ...
    private void InitializeComponent()
    {
      ...
      this.lst_targetUrls = new System.Windows.Forms.ListBox();
      ...
      // groupBox1
      // 
      this.groupBox1.Controls.Add(this.lst_targetUrls);
      ...
      this.groupBox1.Text = "Select URL(s) to open";
      // 
      // lst_targetUrls
      // 
      this.lst_targetUrls.Dock = System.Windows.Forms.DockStyle.Fill;
      this.lst_targetUrls.FormattingEnabled = true;
      this.lst_targetUrls.Location = new System.Drawing.Point(10, 23);
      this.lst_targetUrls.Name = "lst_targetUrls";
      this.lst_targetUrls.SelectionMode = System.Windows.Forms.SelectionMode.MultiExtended;
      this.lst_targetUrls.Size = new System.Drawing.Size(380, 173);
      this.lst_targetUrls.TabIndex = 1;
      this.lst_targetUrls.SelectedIndexChanged += new System.EventHandler(this.lst_targetUrls_SelectedIndexChanged);
      // 
      // btn_close
      // 
      ...
      this.Name = "OpenTargetUrlsForm";
      this.Padding = new System.Windows.Forms.Padding(10);
      this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
      this.Text = "Open target URL(s)";
      this.Load += new System.EventHandler(this.OpenTargetUrlsForm_Load);
      this.KeyUp += new System.Windows.Forms.KeyEventHandler(this.OpenTargetUrlsForm_KeyUp);
    ...
    private System.Windows.Forms.ListBox lst_targetUrls;
